...
public class UserRoleController extends BaseController {
	...
	@RequiresPermissions("auth:userRole:list")
	 ...
	 */
	@GetMapping("/{userId}")
	@RequiresPermissions("auth:userRole:info")
	 ...
	 */
	@PostMapping
	@RequiresPermissions("auth:userRole:add")
	 ...
	 */
	@PutMapping("/{userId}")
	@RequiresPermissions("auth:userRole:update")
	...
	@RequiresPermissions("auth:userRole:delete")
